...
<head>
    ...
    <jsp:useBean id="eduList" type="java.util.List<ru.snx.webapp.model.Organization.Experience>" scope="request"/>
...
<section>
    <form method="post" action="resume" enctype="application/x-www-form-urlencoded">
        ...
        <fieldset>
            ...
            <c:forEach var="exp" items="${eduList}">
                ${exp.startDate} -
            ...
            <input type="hidden" name="edit" value="addEduItem">
