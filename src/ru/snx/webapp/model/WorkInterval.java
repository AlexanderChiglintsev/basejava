...
public class WorkInterval {
    ...
    public WorkInterval(YearMonth start, YearMonth end, String position, String description) {
    ...
    public WorkInterval(YearMonth start, YearMonth end, String description) {
        Objects.requireNonNull(start, "start must not be null !!!");
        Objects.requireNonNull(end, "end must not be null !!!");
        Objects.requireNonNull(description, "position must not be null !!!");
        this.start = start;
    ...
    public boolean equals(Object o) {
        ...
        WorkInterval that = (WorkInterval) o;
